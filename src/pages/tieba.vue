                ...
                <div class="bgcolor-white border-color">
                    <div>
                        ...
                        <div class="margintop10 marginleft20">
                            <span class="tbtopic" v-for="(item,index) in hotKeyWord" :key="index">{{item}}</span>
                        </div>
                        <div style="clear:both;"></div>
                    </div>
                </div>
                    ...
                    <div class="marginbottom20">
                        <div v-for="(item,index) in rankList" :key="index" class="marginleft20 margintop10">
                            <div v-if="index == 0">
                                ...
                                <span class="marginleft20 fontsize4">{{item.title}}</span>
                                </div>
                            ...
                            <div v-if="index > 2" class="marginleft5 margintop20">
                                <div class="floatLeft">
                                    ...
                                    <div class="marginleft30 fontsize4 floatLeft">{{item.title}}</div>
                                    <div style="clear:both;"></div>
                                </div>
                                <div class="floatRight">
                                    <span class="fontsize4">{{item.hotValue}}</span>
